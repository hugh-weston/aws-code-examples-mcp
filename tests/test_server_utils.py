...
class TestReadDocumentationImpl:
    ...
    async def test_successful_html_fetch(self):
        ...
        with patch('httpx.AsyncClient') as mock_client_class:
            ...
            with patch(
                'code_example_server.server_utils.is_html_content',
                return_value=True,
            ):
                with patch(
                    ...
                    with patch(
                        'code_example_server.server_utils.format_documentation_result',
...
class TestVersionImport:
    ...
    def test_version_from_metadata_success(self, mock_version):
        ...
        import code_example_server.server_utils as server_utils
        import importlib

        importlib.reload(server_utils)

        # Verify the version was retrieved from metadata
        mock_version.assert_called_once_with('aws-code-examples-mcp')
    ...
    def test_version_fallback_to_init(self, mock_version):
        ...
        import code_example_server as mcp_server
